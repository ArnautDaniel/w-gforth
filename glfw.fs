...
#65547	constant GLFW_CURSOR_UNAVAILABLE
#65548	constant GLFW_FEATURE_UNAVAILABLE
#65549	constant GLFW_FEATURE_UNIMPLEMENTED
...
#131085	constant GLFW_MOUSE_PASSTHROUGH
...
#139271	constant GLFW_CONTEXT_DEBUG
...
#151553	constant GLFW_WIN32_KEYBOARD_MENU
...
#208901	constant GLFW_RAW_MOUSE_MOTION
...
#225281	constant GLFW_ANGLE_PLATFORM_TYPE_NONE
#225282	constant GLFW_ANGLE_PLATFORM_TYPE_OPENGL
#225283	constant GLFW_ANGLE_PLATFORM_TYPE_OPENGLES
#225284	constant GLFW_ANGLE_PLATFORM_TYPE_D3D9
#225285	constant GLFW_ANGLE_PLATFORM_TYPE_D3D11
#225287	constant GLFW_ANGLE_PLATFORM_TYPE_VULKAN
#225288	constant GLFW_ANGLE_PLATFORM_TYPE_METAL
#221185	constant GLFW_ARROW_CURSOR
#221186	constant GLFW_IBEAM_CURSOR
#221187	constant GLFW_CROSSHAIR_CURSOR
#221188	constant GLFW_POINTING_HAND_CURSOR
#221189	constant GLFW_RESIZE_EW_CURSOR
#221190	constant GLFW_RESIZE_NS_CURSOR
#221191	constant GLFW_RESIZE_NWSE_CURSOR
#221192	constant GLFW_RESIZE_NESW_CURSOR
#221193	constant GLFW_RESIZE_ALL_CURSOR
#221194	constant GLFW_NOT_ALLOWED_CURSOR
...
#327682	constant GLFW_ANGLE_PLATFORM_TYPE
...
c-function glfwSetErrorCallback glfwSetErrorCallback a -- a	( callback -- )
...
c-function glfwGetMonitorWorkarea glfwGetMonitorWorkarea a a a a a -- void	( monitor xpos ypos width height -- )
...
c-function glfwSetMonitorCallback glfwSetMonitorCallback a -- a	( callback -- )
...
c-function glfwSetWindowPosCallback glfwSetWindowPosCallback a a -- a	( window callback -- )
c-function glfwSetWindowSizeCallback glfwSetWindowSizeCallback a a -- a	( window callback -- )
c-function glfwSetWindowCloseCallback glfwSetWindowCloseCallback a a -- a	( window callback -- )
c-function glfwSetWindowRefreshCallback glfwSetWindowRefreshCallback a a -- a	( window callback -- )
c-function glfwSetWindowFocusCallback glfwSetWindowFocusCallback a a -- a	( window callback -- )
c-function glfwSetWindowIconifyCallback glfwSetWindowIconifyCallback a a -- a	( window callback -- )
c-function glfwSetWindowMaximizeCallback glfwSetWindowMaximizeCallback a a -- a	( window callback -- )
c-function glfwSetFramebufferSizeCallback glfwSetFramebufferSizeCallback a a -- a	( window callback -- )
c-function glfwSetWindowContentScaleCallback glfwSetWindowContentScaleCallback a a -- a	( window callback -- )
...
c-function glfwRawMouseMotionSupported glfwRawMouseMotionSupported  -- n	( -- )
...
c-function glfwSetKeyCallback glfwSetKeyCallback a a -- a	( window callback -- )
c-function glfwSetCharCallback glfwSetCharCallback a a -- a	( window callback -- )
c-function glfwSetCharModsCallback glfwSetCharModsCallback a a -- a	( window callback -- )
c-function glfwSetMouseButtonCallback glfwSetMouseButtonCallback a a -- a	( window callback -- )
c-function glfwSetCursorPosCallback glfwSetCursorPosCallback a a -- a	( window callback -- )
c-function glfwSetCursorEnterCallback glfwSetCursorEnterCallback a a -- a	( window callback -- )
c-function glfwSetScrollCallback glfwSetScrollCallback a a -- a	( window callback -- )
c-function glfwSetDropCallback glfwSetDropCallback a a -- a	( window callback -- )
...
c-function glfwSetJoystickCallback glfwSetJoystickCallback a -- a	( callback -- )
